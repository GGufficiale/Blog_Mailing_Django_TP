...
# Тут мы указываем, что для авторизации юзера будет использована именно эта модель

LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = '/'
# Механизм редиректа пользователя на главную страницу после регистрации и выхода из личного кабинета
LOGIN_URL = reverse_lazy('users:login')
# Путь до страницы авторизации, чтобы незареганный юзер не мог посмотреть на товар детально
...
CACHE_ENABLED = True
# См. файл .env (он не переносится в гитхаб)
if CACHE_ENABLED:
